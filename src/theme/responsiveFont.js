...
export const FONT_SIZES = {
  ...
  "28px": { xs: "16px", sm: "20px", md: "24px", lg: "26px", xl: "28px" },
...
// Media breakpoints explanation
// _______________________________________________________________
// | Screen Width | MUI Breakpoint       | Font Variable Used  |
// | ------------ | -------------------- | ------------------- |
// | 0–599px      | `down("sm")`         | `--fontForXXpxXs--` |
// | 600–899px    | `between("sm","md")` | `--fontForXXpxSm--` |
// | 900–1199px   | `between("md","lg")` | `--fontForXXpxMd--` |
// | 1200px+      | `up("lg")`           | `--fontForXXpxLg--` |
// ________________________________________________________________

// __________________________________________________________________________________________
// | Your Variable       | Intended Screen      | Correct MUI Breakpoint Expression         |
// | ------------------- | -------------------- | ----------------------------------------- |
// | `--fontForXXpxXs--` | Extra small (mobile) | `[theme.breakpoints.down("sm")]`          |
// | `--fontForXXpxSm--` | Small tablets        | `[theme.breakpoints.between("sm", "md")]` |
// | `--fontForXXpxMd--` | Medium devices       | `[theme.breakpoints.between("md", "lg")]` |
// | `--fontForXXpxLg--` | Large / Desktop      | `[theme.breakpoints.up("lg")]`            |
// __________________________________________________________________________________________
